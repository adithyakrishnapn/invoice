...
<body style="background-color: orange; margin: 0%;">
    ...
    <div class="select p-3">
        <h2 class="pt-2 pb-2" style="text-align: center; background-color: rgba(0, 0, 0, 0.753); color: white;">SELECT</h2>
        <div class="container-fluid">
            <div class="row">
                <div class="iq col-6 p-3">
                    <h5 style="text-align: center; color: white;">INVOICE</h5><BR>
                        <center><a href="in.php" class="btn btn-warning">ENTER</a></center>
                </div>
                <div class="iq col-6 p-3">
                    <h5 style="text-align: center; color: white;">QUOTATION</h5><BR>
                        <center><a href="quo.php" class="btn btn-warning">ENTER</a></center>
                </div>
            </div>
        </div>
    </div>
