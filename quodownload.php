...
<nav>
  ...
  <h3 style="text-align: center; color: white;">GST INCLUDED</h3><br>
    <form action="quodownload.php" method="get">
  ...
  <div class="pdf-item">
    <a href="uploads/quotation/ingst/<?php echo $file; ?>" target="_blank"><?php echo $file; ?></a>
    <form action="quodelete.php" method="POST">
