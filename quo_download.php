...
<nav>
    ...
    <h1 style="text-align: center; background-colo: white;">SEE ALL PDF's</h1>
    <div class="container">
		<a href="quodownload.php" class="btn">GST Included</a>
		<a href="quo_download.php" class="btn">GST Excluded</a>
	</div><br>
  <h3 style="text-align: center; color: white;">GST EXCLUDED</h3><br>
    <form action="quo_download.php" method="get">
  ...
  <div class="pdf-item">
    <a href="uploads/quotation/exgst/<?php echo $file; ?>" target="_blank"><?php echo $file; ?></a>
    <form action="quo_delete.php" method="POST">
