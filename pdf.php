...
$sql = "INSERT INTO invoices(client_name, email, address, daddress, total) VALUES ('$name', '$email', '$daddress','".$pdfData['address']."',".$pdfData['total'].")";
//select Max id
...
$pdf->Cell(40, 10, $pdfData['address']."\n", 0, 0);
$pdf->Cell(100, 5,"\n", 0, 0);
$pdf->SetFillColor(255, 255, 255);
$pdf->MultiCell(0, 5, $daddress."\n",0, 1,'R');
...
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(50, 10, $product['product'].'\n', 1,0,'C');
$pdf->SetFont('Arial', '', 12);
...
// generate filename
$filename = 'uploads/invoice/ingst/'.'INgst '.$id.' '.$name . '.pdf';
