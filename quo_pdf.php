...
$sql = "INSERT INTO qtgst(client_name, email, address, total) VALUES ('$name', '$email', '".$pdfData['address']."',".$pdfData['total'].")";
...
// generate filename
$filename = 'uploads/quotation/exgst/'.' EXgst '.$id.' '.$name . '.pdf';
